...
module.exports = function(app) {
  ...
  function getFileViewTag(property, value, model, cssclass) {
    var subtype = model.subtype && model.subtype.type || '';
    var template = '<textarea name="%s" id="%s" class="%s" rows=6 readonly>%s</textarea>';
    var valueString = value ? JSON.stringify(value, null, 2) : '';
    var result = util.format(template, property, property, cssclass, valueString);
    return result;
  }
